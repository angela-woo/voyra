  ...
  return (
    <div className="max-w-[var(--measure)] mx-auto px-6 py-20">
      <div className="text-center mb-16">
        <Globe className="w-8 h-8 text-[color:var(--ink-faint)] mx-auto mb-5" />
        <h1 className="editorial-heading text-4xl mb-4">
          Kiravoy에 대하여
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
        {[
          ...
          <div key={item.title} className="border-t border-[var(--border)] pt-5 text-center">
            <div className="flex justify-center mb-3 text-[color:var(--ink-faint)]">{item.icon}</div>
            <h3 className="mb-2" style={{ fontFamily: 'var(--font-heading)', fontWeight: 700 }}>{item.title}</h3>
      ...
      <div className="prose max-w-none">
        ...
        <section>
          <div className="not-prose flex items-center gap-2 mb-3">
            <Cpu className="w-4 h-4 text-[color:var(--ink-faint)]" />
            <h2 className="m-0">콘텐츠 정책</h2>
          </div>
          <p>
        ...
        <section>
          <div className="not-prose flex items-center gap-2 mb-3">
            <Shield className="w-4 h-4 text-[color:var(--ink-faint)]" />
            <h2 className="m-0">광고 및 제휴 안내</h2>
          </div>
          <p>
            Kiravoy는 서비스 운영을 위해 Google AdSense 광고와 일부 제휴사의 어필리에이트 링크를 사용합니다.
        ...
        <section>
          <div className="not-prose flex items-center gap-2 mb-3">
            <Mail className="w-4 h-4 text-[color:var(--ink-faint)]" />
            <h2 className="m-0">운영자 정보</h2>
          </div>
              ...
              <tbody>
                {[
                  ...
                  <tr key={k} className="border-b border-[var(--border)] last:border-0">
                    <td className="py-2.5 px-4 text-[color:var(--ink-faint)] w-36">{k}</td>
          ...
          <p>
            문의사항은 <Link href="/contact">문의 페이지</Link>를 통해 남겨주시거나
