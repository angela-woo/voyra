...
export default function PrivacyPage() {
  return (
    <div className="max-w-[var(--measure)] mx-auto px-6 py-20">
      <h1 className="editorial-heading text-3xl mb-2">
        개인정보처리방침
      </h1>
      <p className="text-sm text-[color:var(--ink-faint)] mb-12">시행일: 2025년 5월 1일 · 최종 수정: 2026년 5월</p>

      <div className="prose max-w-none">

        <section>
          <h2>제1조 개인정보처리자 정보</h2>
          <div className="not-prose border border-[var(--border)]">
              ...
              <tbody>
                {[
                  ...
                  <tr key={k} className="border-b border-[var(--border)] last:border-0">
                    <td className="py-2.5 px-4 text-[color:var(--ink-faint)] w-40">{k}</td>
                    <td className="py-2.5 px-4 text-[color:var(--ink)]">{v}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <section>
          ...
          <p><strong>수집 방법:</strong> 회원가입 폼을 통한 직접 입력</p>
        </section>
        ...
        <section>
          ...
          <div className="not-prose border border-[var(--border)] overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-[var(--border)]">
                  <th className="py-2.5 px-4 text-left eyebrow">수탁업체</th>
                  <th className="py-2.5 px-4 text-left eyebrow">국가</th>
                  <th className="py-2.5 px-4 text-left eyebrow">이전 항목</th>
                  <th className="py-2.5 px-4 text-left eyebrow">목적</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="py-2.5 px-4 text-[color:var(--ink)]">Supabase Inc.</td>
                  <td className="py-2.5 px-4 text-[color:var(--ink)]">미국</td>
                  <td className="py-2.5 px-4 text-[color:var(--ink)]">이메일, 닉네임, 세션 정보</td>
                  <td className="py-2.5 px-4 text-[color:var(--ink)]">데이터베이스 및 인증 서비스</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section>
          ...
          <p>위 권리 행사는 이메일(<strong>imrubywoo@gmail.com</strong>)로 요청하시면 10영업일 이내에 처리합니다.</p>
        </section>

        <section>
          <h2>제9조 광고 서비스 및 쿠키 사용</h2>
          <p>
