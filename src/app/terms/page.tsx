...
export default function TermsPage() {
  return (
    <div className="max-w-[var(--measure)] mx-auto px-6 py-20">
      ...
      <p className="text-sm text-[color:var(--ink-faint)] mb-12">시행일: 2026년 5월 22일</p>
      ...
      <div className="prose max-w-none">
        ...
        <section>
          ...
          <p>위 행위 발견 시 사전 통보 없이 계정 정지 또는 탈퇴 처리될 수 있습니다.</p>
        </section>
        ...
        <section>
          ...
          <p>이용자가 해당 링크를 통해 예약·구매하는 경우, 서비스는 소정의 수수료를 받을 수 있습니다. 링크를 통한 예약 가격은 직접 예약과 동일하며, 이용자에게 추가 비용이 발생하지 않습니다.</p>
        </section>
